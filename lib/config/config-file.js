...
function getBaseDir(configFilePath) {
    ...
    // calculates the path of the project including BSLint as dependency
    ...
    /*
     * default to BSLint project path since it's unlikely that plugins will be
     * in this directory
     */
 ...
 * - 'configFullName' (required) the name of the configuration as used in the bslint config(e.g. 'plugin:node/recommended'),
